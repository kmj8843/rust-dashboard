...
use crate::app::{
    ...
    models::{person::EditPersonRequest, Person},
    server_functions::persons::edit_person,
};

use super::ToastMessage;

const INPUT_STYLE: &str = "w-full h12 bg-[#333333] pr-4 pl-6 py-4 text-white mt-6 outline-none focus:outline-none focus:pl-7 transition-all duration-1000 ease-in-out";
    ...
    view! {
        <div class="flex flex-col w-full h-full z-50 mx-auto items-center align-middle">
            <div class=move || { if if_error() { ERROR_STYLE } else { NO_ERROR_STYLE } }>
                ...
                <div class="flex flex-row w-full items-right justify-center mt-3">
