...
use leptos::{
    component, create_signal, view, IntoView, Resource, ServerFnError, Show, WriteSignal,
};

use crate::app::models::Person;

use super::{EditPersonModal, ShowPersonModal, ToastMessage};
    ...
    view! {
        ...
        <div class=ROW_STYLE>
            ...
            <div class="flex flex-row">
                <button class=SHOW_ICON_STYLE on:click=on_show_info>
                    "i"
                </button>
                <button class="" on:click=on_show_edit>
                    <img
                        src="assets/edit.png"
                        class="w-[35px] hover:w-[38px] transition-all duration-500"
                    />
                </button>
            </div>
        </div>
